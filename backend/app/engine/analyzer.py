...
async def analyze_game(
    ...
    Args:
        ...
        moves: List of chess moves to analyze
        headers: PGN headers (Event, White, Black, etc.)
    ...
    Returns:
        Complete game analysis result with move classifications and statistics
    """
    ...
    for i, move in enumerate(moves):
        try:
            ...
            # CRITICAL FIX: Classify the move with win-rate based system
            # Pass the correct best_move_uci so classifier knows if this is the best move
            ...
            move_analysis = MoveAnalysis(
                ...
                engine=EngineEvaluation(
                    best_move=best_move_uci,
                    played_eval_cp=played_eval_cp_white,  # Always from White's perspective for display
...
def get_analysis_result(task_id: str) -> Optional[GameAnalysisResult]:
    ...
    Returns:
        GameAnalysisResult if found, None otherwise
    """
